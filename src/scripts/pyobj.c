...
PyObject* PyObj_richcompare(PyObject *pyobj1, PyObject *pyobj2, int op) {
    ...
    if (pyobj1 == Py_None || pyobj2 == Py_None) {
    ...
    if (!PyObj_Check(pyobj1) || !PyObj_Check(pyobj2)) {
        log_string("Both operands must be PyObj objects.");
        PyErr_SetString(PyExc_TypeError, "Both operands must be PyObj objects");
        Py_RETURN_FALSE;
    }
...
int PyObj_setname(PyObj *self, PyObject *value, void *closure) {
  ...
  objSetName(obj, PyUnicode_AsUTF8(value));
  return 0;
}
...
int PyObj_setmname(PyObj *self, PyObject *value, void *closure) {
  ...
  OBJ_DATA *obj;
  PYOBJ_CHECK_OBJ_EXISTS(self->uid, obj);
  objSetMultiName(obj, PyUnicode_AsUTF8(value));
  return 0;
}
...
int PyObj_setbits(PyObj *self, PyObject *value, void *closure) {
  ...
  bitSet(objGetBits(obj), PyUnicode_AsUTF8(value));
  return 0;
}
...
int PyObj_setdesc(PyObj *self, PyObject *value, void *closure) {
  ...
  OBJ_DATA *obj;
  PYOBJ_CHECK_OBJ_EXISTS(self->uid, obj);
  objSetDesc(obj, PyUnicode_AsUTF8(value));
  return 0;
}
...
int PyObj_setrdesc(PyObj *self, PyObject *value, void *closure) {
  ...
  OBJ_DATA *obj;
  PYOBJ_CHECK_OBJ_EXISTS(self->uid, obj);
  objSetRdesc(obj, PyUnicode_AsUTF8(value));
  return 0;
}
...
int PyObj_setmdesc(PyObj *self, PyObject *value, void *closure) {
  ...
  OBJ_DATA *obj;
  PYOBJ_CHECK_OBJ_EXISTS(self->uid, obj);
  objSetMultiRdesc(obj, PyUnicode_AsUTF8(value));
  return 0;
}
...
int PyObj_sethidden(PyObject *self, PyObject *value, void *closure) {
  ...
  if(value == NULL || value == Py_None)
    ...
    objSetHidden(obj, PyLong_AsLong(value));
  else {
    PyErr_Format(PyExc_TypeError,
...
int PyObj_setcarrier(PyObj *self, PyObject *value, void *closure) {
  ...
  if(objGetWearer(obj)) {
    ...
    if(!try_unequip(objGetWearer(obj), obj)) {
      PyErr_Format(PyExc_Exception, "Could not unequip previous wearer.");
      return -1;
    }
  }
...
int PyObj_setroom(PyObj *self, PyObject *value, void *closure) {
  ...
  if(objGetWearer(obj)) {
    // weird... we couldn't unequip the item from the current wearer
    if(!try_unequip(objGetWearer(obj), obj)) {
      PyErr_Format(PyExc_Exception, "Could not unequip wearer.");
      return -1;
    }
  }
...
PyObject *PyObj_setvar(PyObj *self, PyObject *args) {  
  ...
  if(obj != NULL) {
    if(PyLong_Check(val))
      objSetInt(obj, var, (int)PyLong_AsLong(val));
    else if(PyFloat_Check(val))
      objSetDouble(obj, var, PyFloat_AsDouble(val));
    else if(PyUnicode_Check(val))
      objSetString(obj, var, PyUnicode_AsUTF8(val));
    else {
      PyErr_Format(PyExc_TypeError,
...
PyTypeObject PyObj_Type = {
    ...
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    NULL,                      /* (cmpfunc)PyObj_compare, tp_compare*/
    0,                         /*tp_repr*/
    0,                         /*tp_as_number*/
    0,                         /*tp_as_sequence*/
    0,                         /*tp_as_mapping*/
    ...
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    (richcmpfunc)PyObj_richcompare,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    0,                         /* tp_methods */
...
static struct PyModuleDef obj_moduledef = {
    ...
    "obj",               // <-- should match what WAS in InitModule3
    "Contains the Python wrapper for game objects. Also contains utilities\n"
    "for listing, storing, and generating objects from prototypes.",
    -1,                     // ?
    obj_module_methods,    // Module methods
    NULL,                   // m_slots
    NULL,                   // m_traverse
    NULL,                   // m_clear
    NULL                    // m_free
...
PyInit_PyObj(void) {
    ...
    PyObj_addMethod("do_trigs", py_gen_do_trigs, METH_VARARGS | METH_KEYWORDS,
