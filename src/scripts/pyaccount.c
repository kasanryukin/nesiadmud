...
PyObject *PyAccount_richcompare(PyObject *obj1, PyObject *obj2, int op) {

    if (op != Py_EQ && op != Py_NE) {
      log_string("Invalid comparison operator for accounts.");
      PyErr_SetString(PyExc_TypeError, "Invalid comparison operator for accounts.");
      Py_RETURN_FALSE;
    }

    if (!PyAccount_Check(obj1) || !PyAccount_Check(obj2)) {
    ...
    retval = !strcasecmp(accountGetName(acc1->account), accountGetName(acc2->account));

    // flip the value if it's NE
    if (op == Py_NE)
...
PyObject *PyAccount_characters(PyAccount *self, PyObject *args) {
  ...
  ITERATE_LIST(name, name_i) {
    PyObject *val = PyUnicode_FromString(name);
...
PyTypeObject PyAccount_Type = {
    ...
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    NULL,                      // (cmpfunc)PyAccount_compare,
    0,                         /*tp_repr*/
    0,                         /*tp_as_number*/
    0,                         /*tp_as_sequence*/
    0,                         /*tp_as_mapping*/
    ...
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    (richcmpfunc)PyAccount_richcompare,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    0,                         /* tp_methods */
...
static struct PyModuleDef account_moduledef = {
    ...
    "account",               // <-- should match what WAS in InitModule3
    "Contains the Python wrapper for accounts.", // <-- should match what WAS in InitModule3
    -1,                     // ?
    account_module_methods,    // Module methods
    NULL,                   // m_slots
    NULL,                   // m_traverse
    NULL,                   // m_clear
    NULL                    // m_free
