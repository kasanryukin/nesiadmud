...
int PyObj_setcontainercapacity(PyObject *self, PyObject *value, void *closure) {
  OBJ_DATA *obj = PyObj_AsObj(self);
  if(obj == NULL) {
    PyErr_Format(PyExc_Exception, "Tried to set capacity for nonexistent "
...
int PyObj_setcontainerkey(PyObject *self, PyObject *value, void *closure) {
  ...
  const char *key = NULL;
  if(obj == NULL) {
    PyErr_Format(PyExc_Exception, "Tried to set key for nonexistent "
		 "container, %d", PyObj_AsUid(self));
    return -1;
  }
  else if(!objIsType(obj, "container")) {
  ...
  if(PyUnicode_Check(value))
    key =get_fullkey(PyUnicode_AsUTF8(value),get_key_locale(objGetClass(obj)));
...
int PyObj_setcontainerpickdiff(PyObject *self, PyObject *value, void *closure) {
  OBJ_DATA *obj = PyObj_AsObj(self);
  if(obj == NULL) {
    PyErr_Format(PyExc_Exception, "Tried to change pickdiff on nonexistent "
		 "container, %d", PyObj_AsUid(self));
    return -1;
  }
  else if(!objIsType(obj, "container")) {
  ...
  containerSetPickDiff(obj, PyLong_AsLong(value));
  return 0;
}
...
int PyObj_setcontainerclosable(PyObject *self, PyObject *value, void *closure) {
  OBJ_DATA *obj = PyObj_AsObj(self);
  if(obj == NULL) {
    PyErr_Format(PyExc_Exception, "Tried to change closable on nonexistent "
		 "container, %d", PyObj_AsUid(self));
    return -1;
  }
  else if(!objIsType(obj, "container")) {
  ...
  containerSetClosable(obj, PyLong_AsLong(value));
...
int PyObj_setcontainerclosed  (PyObject *self, PyObject *value, void *closure) {
  OBJ_DATA *obj = PyObj_AsObj(self);
  if(obj == NULL) {
    PyErr_Format(PyExc_Exception, "Tried to change closed on nonexistent "
		 "container, %d", PyObj_AsUid(self));
    return -1;
  }
  else if(!objIsType(obj, "container")) {
  ...
  containerSetClosed(obj, PyLong_AsLong(value));
  if(PyLong_AsLong(value) == 0)
    containerSetLocked(obj, FALSE);
  else
...
int PyObj_setcontainerlocked  (PyObject *self, PyObject *value, void *closure) {
  OBJ_DATA *obj = PyObj_AsObj(self);
  if(obj == NULL) {
    PyErr_Format(PyExc_Exception, "Tried to change locked on nonexistent "
		 "container, %d", PyObj_AsUid(self));
    return -1;
  }
  else if(!objIsType(obj, "container")) {
  ...
  containerSetLocked(obj, PyLong_AsLong(value));
  if(PyLong_AsLong(value) != 0) {
    containerSetClosable(obj, TRUE);
